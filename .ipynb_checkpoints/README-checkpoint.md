...
If you want to use mysql instead of sqlite3, or your own invite code check progress, please edit line 286 to line 320 at the ```backend/o365_creater_auth.py``` file:
